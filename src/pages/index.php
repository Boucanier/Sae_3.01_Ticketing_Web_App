...
<main id="main_page">
    <div id="presentation">
        ...
        <div id="video_explicative">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/watch?v=lMOt3tfJuWo&ab_channel=GolemCorp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
    </div>
